...
import {
  ResponsiveContainer, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, Cell, LabelList, Brush
} from "recharts";
              ...
              >
                {Data.map((entry, index) => {
                  return (
                    <Cell
                      key={`cell-${index}`}
                      stroke={color(entry.Valor)}
                      strokeWidth={entry.Usuario === props.Activo ? 6 : 3}
                    />
                  );
                })}
