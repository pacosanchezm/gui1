...
import {
  CardNumberElement, CardExpiryElement, CardCVCElement, injectStripe, StripeProvider, Elements} from "react-stripe-elements";
    ...
    <div>
            ...
            <Box bg="White" css={{ height: 5 }} />
              ...
              <Flex>
                <Box bg="White" css={{ height: 34 }} />
                <Text sx={Estilo.t3s}>
                  ¿Deseas incluir un extra para los  artistas?
                </Text>
              </Flex>
      ...
      if (Cliente > 0) {
        if (props.stripe) {
          ...
          if (Pago === 1) {
            ...
            setIndica(
              "GRACIAS POR TU COMPRA! Si tienes dudas comunícate al 477 274 0011"
            );
            ...
            setIndica("Si tienes dudas comunícate al 477 274 0011");
          }
        } else {
