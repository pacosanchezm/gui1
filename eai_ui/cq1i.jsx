...
import CoverPage from "./cs1cover";
import ProductPage from "./cs1prods";
import Detalle from "./cs1det";
import Registros from "./cq1check";
...
const Encabezado = props => {
  ...
  var channel = pusher.subscribe('cscliente');
  

  useEffect(() => {
    useDataMx.Pedidos().getQ(props)
    
    setParticipante(props.token)
  ...
  channel.bind('update', handler, {Pedido:Pedido});
