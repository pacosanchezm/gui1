...
const Listado1 = props => {
  try {
    ...
    const Renglon1 = props => {
      ...
      if (props.Row.Tipo === "INCREMENTO") {
        TipoSimple = "+";
        TipoSimpleColor = "green";
      }

      if (props.Row.Tipo === "DECREMENTO") {
        TipoSimple = "-";
        TipoSimpleColor = "red";
      }
          ...
          <div>
            <cssfibo.MyFlex1 css={{ backgroundColor: BgColor }}>
              <cssx.box3label css={{ width: "110px" }}>
                ...
                <cssx.h3 css={{ fontSize: 8 }}>{props.Row.Folio}</cssx.h3>
              </cssx.box3label>
              ...
              <cssx.box3label css={{ width: "21px", paddingRight: 21 }}>
                <cssx.h3 css={{ color: TipoSimpleColor, textAlign: "right" }}>
                  {props.Row.Puntos}
                </cssx.h3>
              </cssx.box3label>
