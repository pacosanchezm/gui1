        ...
        <Flex sx={{ width: "100%" }}>
          <ResponsiveContainer width={"100%"} height={"100%"} aspect={2}>
            <LineChart
              ...
              data={Data}
              onClick={v => {
                if (Activo.value === v.activePayload[0].payload.Hora) {
                  setActivo({ value: null, label: "Todas" });
                } else {
                  setActivo({
                    value: v.activePayload[0].payload.Hora,
                    label: v.activePayload[0].payload.Hora
                  });
                }
              }}
            >
